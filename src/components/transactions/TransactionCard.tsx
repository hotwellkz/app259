...
export const TransactionCard: React.FC<TransactionCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute inset-y-0 left-0 w-16 bg-blue-500 flex items-center justify-center transition-opacity duration-200 ${
          isExpanded && swipeDirection === 'right' ? 'opacity-100' : 'opacity-0'
        }`}
      >
      ...
      <div
        className={`p-4 transition-transform duration-200 ${
          isExpanded && swipeDirection === 'left' ? '-translate-x-16' : 
          isExpanded && swipeDirection === 'right' ? 'translate-x-16' : 
          'translate-x-0'
        }`}
      >
